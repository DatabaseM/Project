        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Sale Transaction Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$dbname = "inventory";
    ...
    $sql = "SELECT transsell.tsid,stock.pid,stock.name,transsell.date,transsell.quantity,transsell.amount,transsell.tax,transsell.total,customer.cid,customer.name AS cname FROM transsell INNER JOIN stock ON transsell.pid=stock.pid INNER JOIN customer ON transsell.cid=customer.cid 
