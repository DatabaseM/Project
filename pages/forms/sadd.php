        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Sell Transaction</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="saddt.php">
              <div class="box-body">
                  
               <div class="form-group">
                  <label for="exampleInputEmail1">Transaction ID</label>
                  <input type="number" class="form-control" id="exampleInputEmail1" name="tsid" placeholder="Enter Transasction Id">
                </div>
                           <div class="form-group">
                  <label>Product</label>
