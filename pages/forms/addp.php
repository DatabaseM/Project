    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="addp.php#"><i class="fa fa-circle-o"></i>  Add Products</a></li>
            <li><a href="tablep.php#"><i class="fa fa-circle-o"></i>  Inventory List</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="sadd.php#"><i class="fa fa-circle-o"></i> New Transaction</a></li>
                  <li><a href="tablest.php#"><i class="fa fa-circle-o"></i> View Transactions</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="addpp.php">
              <div class="box-body">
                  
                  
                  <div class="form-group">
                  <label for="exampleInputEmail1">Product ID</label>
                  <input type="number" class="form-control" id="customerid" name="pid" placeholder="Enter Product id">
                </div>
                  
                <div class="form-group">
                  <label for="exampleInputEmail1">Product Name</label>
                  <input type="text" class="form-control" id="cname" name="pname" placeholder="Enter Name">
                </div>
                 
                <div class="form-group">
                  <label for="exampleInputEmail1">Product HSN no</label>
                  <input type="number" class="form-control" id="ccno" name="hsn" placeholder="Enter HSN no">
                </div>
                  
               <div class="form-group">
                  <label for="exampleInputEmail1">Product Quantity</label>
                  <input type="number" class="form-control" name="qty" id="cemail" placeholder="Enter Quantity">
                </div>
                       
             <div class="form-group">
                  <label>Product Unit</label>
                  <input type="text" class="form-control" id="cadd" name="unit" placeholder="Enter Unit">
                </div>
                   <div class="form-group">
