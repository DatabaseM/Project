      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ups.html#"><i class="fa fa-circle-o"></i> Update Supplier Details</a></li>
            <li><a href="dels.html#"><i class="fa fa-circle-o"></i> Delete Supplier</a></li>  
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="addpp.php">
             ...
             <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="cadd" name="unit" placeholder="Enter Unit">
                </div>
                   <div class="form-group">
