  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Stock tables</li>
      </ol>
    </section>
...
$dbname = "inventory";
    ...
    $sql = "SELECT transbuy.tbid,stock.pid,stock.name,transbuy.date,transbuy.quantity,transbuy.amount,transbuy.tax,transbuy.total,supplier.sid,supplier.name AS sname FROM transbuy INNER JOIN stock ON transbuy.pid=stock.pid INNER JOIN supplier ON transbuy.sid=supplier.sid  
ORDER BY `stock`.`name`  DESC";
