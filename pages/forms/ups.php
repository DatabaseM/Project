      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="supdate.php">
              <div class="box-body">
...
$dbname = "inventory";
    ...
    ?>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">New Supllier Name</label>
                  <input type="text" class="form-control" id="cname" name="nname" placeholder="Enter Name">
                </div>
                 
                <div class="form-group">
                  <label for="exampleInputEmail1">New Contact no</label>
                  <input type="number" class="form-control" id="ccno" name="cno" placeholder="Enter Contact">
                </div>
             ...
             <div class="form-group">
                 ...
                 <textarea rows=3 cols=75 id="cadd" name="email" placeholder="Enter Address"></textarea>
                </div>
