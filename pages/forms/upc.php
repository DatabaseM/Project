      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="cupdate.php">
              <div class="box-body">
...
$dbname = "inventory";
    ...
    ?>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">New Contact no</label>
                  <input type="number" class="form-control" id="ccno" name="cno" placeholder="Enter New Contact">
                </div>
                  
               <div class="form-group">
                  <label for="exampleInputEmail1">New Email Address</label>
                  <input type="email" class="form-control" id="cemail" name="email" placeholder="Enter New Email">
                </div>
                       
             <div class="form-group">
                  <label>New Address</label>
                 <textarea rows=3 cols=75 id="cadd" name="add" placeholder="Enter New Address"></textarea>
                </div>
