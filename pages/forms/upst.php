      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action=" pupdate.php">
              <div class="box-body">
...
$dbname = "inventory";
    ...
    ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="cname" name="nname" placeholder="Enter New Name">
                </div>
                 
                <div class="form-group">
                  <label for="exampleInputEmail1">New HSN no</label>
                  <input type="number" class="form-control" id="ccno" name="nhsn" placeholder="Enter New HSN no">
                </div>
                  
               <div class="form-group">
                  <label for="exampleInputEmail1">New Quantity</label>
                  <input type="number" class="form-control" id="cemail" name="nqty" placeholder="Enter New Quantity">
                </div>
                       
             <div class="form-group">
                  <label>New Unit</label>
                  <input type="text" class="form-control" id="cadd" name="nunit" placeholder="Enter New Unit">
                </div>
                             <div class="form-group">
